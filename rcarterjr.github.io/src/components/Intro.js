	...
	render() {
		return (
			<div className={"frontAndCenter"}>
				...
				<div className={"imean"}>
					<img src={require("../newMug2.jpg")} className="Russ" alt="Russ" />
				</div>
				<div>
					<div>
						<h1 className="App-title"> Hello, I'm Russell!</h1>
					</div>
					<div>
						<h2>Software Developer | Computer Science student | Dog owner </h2>
					</div>
				</div>
				<div
					style={{
