            ...
            <div className={"frontAndCenter"}>
                ...
                <header>
                    ...
                    <ul className={"nav justify-content-end"}>
                        <li className={"zoom"} style={{marginRight: '15px'}}>
                            <SmoothScroll href='#AboutMe'><a className="nav-link" href="#">About Me</a></SmoothScroll>
                        </li>
                        <li className={"zoom"}>
                            <a className={"nav-link"} href="mailto:russell.c12@gmail.com">Email Me</a>
                        </li>
                    </ul>
                    </div>
                </header>
                ...
                <div style={{display: 'flex', justifyContent: 'space-around', width: '60vw',  paddingTop: 16}}>
                    <a href="https://github.com/rcarterjr">
                        <div className="img"><img src={require("./iconmonstr-github-1.svg")} style={{height: 56, width: 56, }} alt="Github"/></div>
                    </a>
                    <a href="https://www.linkedin.com/in/russell-c-38b69486/">
                        <div className="img"><img src={require("./iconmonstr-linkedin-4.svg")} style={{height: 56, width: 56}} alt="Linkedin" /></div>
                    </a>
                    <a href="https://twitter.com">
                        <div className="img"><img src={require("./iconmonstr-twitter-4.svg")} style={{height: 56, width: 56}} alt="Twitter"/></div>
                    </a>
                </div>
                <SmoothScroll/>
            </div>
